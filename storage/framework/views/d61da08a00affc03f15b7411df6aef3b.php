        ...
        <form action="<?php echo e(route('register.post')); ?>" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="nome" value="<?php echo e(old('nome')); ?>" required autocomplete="name">
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="estado" value="<?php echo e(old('estado')); ?>" placeholder="SP" maxlength="2" required>
                </div>
                <div class="col-md-6">
...
<?php /**PATH /Users/guilhermecordeiro/Projects/BrainRot/resources/views/register.blade.php ENDPATH**/ ?>